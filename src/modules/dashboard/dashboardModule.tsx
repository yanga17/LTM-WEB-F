...
export const DashboardModule = () => {
    ...
    const filterCustomerErrorsChart = async () => {
        try {
            //http://localhost:4200/dashboard/getcustomerdata/2024-06-01 08:00:17/2024-06-18 08:00:00
            ...
            <div className="grid grid-cols-4 gap-5 mt-3">
                ...
                <div className="text-gray-800 flex flex-col justify-around p-2 rounded bg-white shadow">
                    ...
                    <div key={index} className="uppercase">
                        ...
                        <div className="mt-4 flex justify-between">
                            <p>No. Completed Customer Errors</p>
                            <p>{summary.ErrorsCompleted}</p>
                        </div>
                        <div className="mt-4 flex justify-between">
                            <p>No. Overall Completed Tickets</p>
                ...
                <div className="w-full rounded p-2 shadow h-[450px] bg-white flex items-start justify-between flex-col">
                    <div className="flex items-center justify-between w-full h-[15%]">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={ filterCustomerErrorsChart } className="flex justify-start bg-purple py-4 px-2 w-24 h-18 mr-8 lg:h-19 lg:px-4 lg:py-4 lg:mr-8 gap-2 ml-2  hover:bg-white text-white hover:text-purple border border-purple cursor-pointer rounded-full">
                                <span>Filter</span>
                                <Filter className="h-4 w-4 mt-1" />
                            </button>
                        </div>
                ...
                <div className="w-full rounded p-2 shadow h-[450px] bg-white flex items-start justify-between flex-col">
                    <div className="flex items-center justify-between w-full h-[15%]">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={ filterEmployeeTasksChart } className="flex justify-start bg-purple py-4 px-2 w-24 h-18 mr-8 lg:h-19 lg:px-4 lg:py-4 lg:mr-8 gap-2 ml-2  hover:bg-white text-white hover:text-purple border border-purple cursor-pointer rounded-full">
                                <span>Filter</span>
                                <Filter className="h-4 w-4 mt-1" />
                            </button>
                        </div>
                ...
                <div className="w-full rounded p-2 shadow h-[450px] bg-white flex items-start justify-between flex-col">
                    <div className="flex items-center justify-between w-full h-[15%]">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={ filterCustomerCallChart } className="flex justify-start bg-purple py-4 px-2 w-24 h-18 mr-8 lg:h-19 lg:px-4 lg:py-4 lg:mr-8 gap-2 ml-2  hover:bg-white text-white hover:text-purple border border-purple cursor-pointer rounded-full">
                                <span>Filter</span>
                                <Filter className="h-4 w-4 mt-1" />
                            </button>
                        </div>
