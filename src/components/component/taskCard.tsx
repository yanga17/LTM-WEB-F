...
export function TaskCard() {
    ...
    return (
            <div className="hover:-translate-y-2 group bg-neutral-50 duration-500 w-44 h-44 flex text-neutral-600 flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md">
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="absolute blur z-10 fill-blue duration-500 group-hover:blur-none group-hover:scale-105">
                ...
                {totalTasks?.map(({ NumberOfTasks }) => (
                <div className="z-20 flex flex-col justify-center items-center">
                    <span className="font-bold text-6xl ml-2">
                        { NumberOfTasks }
                    </span>
                    <p className="font-bold uppercase">Completed Tasks</p>
                </div>
                ))}
            </div>
    )
